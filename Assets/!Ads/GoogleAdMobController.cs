...
public class GoogleAdMobController : MonoBehaviour
{
    ...
    public void ShowRewardedAd()
    {
        ...
        else
        {
            ...
            StartCoroutine(Rewarded("Rewarded ad is not ready"));
    ...
    IEnumerator Rewarded(string Text)
    {
    ...
    public void RequestAndLoadAppOpenAd()
    {
        ...
        AppOpenAd.LoadAd(appOpenId, ScreenOrientation.Portrait, CreateAdRequest(), (appOpenAd, error) =>
        {
            if (error != null)
            {
                MobileAdsEventExecutor.ExecuteInUpdate(() =>
